    ...
    return (
        <div className="w-full px-4 py-6">
            ...
            <div className="text-center mb-4">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white transition-colors duration-200 ease-in-out">Tomato Leaf Detection Tool</h2>
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-1 transition-colors duration-200 ease-in-out">
                    Upload a photo of a <span className="text-green-600 dark:text-green-400 font-medium transition-colors duration-200 ease-in-out">tomato plant leaf</span> to get the disease diagnosis.
                </p>
            </div>
