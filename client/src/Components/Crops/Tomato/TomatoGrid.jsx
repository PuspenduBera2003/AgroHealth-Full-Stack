    ...
    return (
        <div className="p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {tomatoDiseases.map((disease, index) => (
                <div key={index} className={`flex flex-col bg-gradient-to-r rounded-lg p-6 shadow-xl transition-all transform hover:scale-105 hover:shadow-2xl duration-200 ease-in-out 
