...
const CropFarmings = () => {
    return (
        <div className='relative md:h-screen bg-gradient-to-br flex items-center justify-center mx-1'>
            ...
            {/* Glassy Card */}
            <div className='relative z-10 flex flex-col gap-1 items-center justify-center flex-wrap bg-white/30 dark:bg-white/10 transition-colors duration-200 ease-in-out backdrop-blur-lg shadow-lg rounded-3xl p-5 md:p-6'>
                <div className='flex flex-wrap items-center justify-center flex-col gap-2'>
                    <div className='transition-colors duration-200 ease-in-out dark:text-white text-xl font-semibold'>
                        Crop Farming
                    </div>
