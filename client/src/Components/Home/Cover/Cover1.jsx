...
const Cover1 = () => {
    return (
        <div className='flex p-2 gap-0 lg:gap-10 justify-end w-full items-center flex-wrap'>
            ...
            <div className='flex flex-wrap items-center justify-center gap-3 md:gap-10 rounded-lg bg-gradient-to-r from-lime-50 via-white to-lime-100 dark:from-stone-700 dark:via-stone-800 dark:to-stone-900 dark:bg-transparent p-2 shadow-lg border-gray-600 dark:border transition-colors duration-200 ease-in-out'>
                ...
                <div className='md:relative flex flex-col items-center justify-center gap-2'>
                    ...
                    <div className='md:absolute bottom-2 left-20'>
                        <Link
                            ...
                            offset={50}
                            duration={500}
                            className="text-white cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-colors duration-200 ease-in-out">
                            Get Started
